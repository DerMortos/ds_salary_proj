...
# initial attempt to use selenium to scrape linkedin salary data
# .find_element* method has been updated since original code was written
# calling .click() in line 66 results in stale data , element no longer in DOM (Document Object Model)
#
#original code from https://github.com/arapfaik/scraping-glassdoor-selenium/blob/master/glassdoor%20scraping.ipynb
#
#following tutorial by Ken Jee https://www.youtube.com/watch?v=GmW4F6MHqqs&list=PL2zq7klxX5AReJn7nZfqOKLZ3IpKj7fwc&index=26
...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        #             # selenium 4.3.0 deprecated find_element_by_*
        ...
        while not done:
            ...
            job_buttons = driver.find_elements(By.XPATH, "//article[@id='MainCol']//ul/li[@data-adv-type='GENERAL']") #In Selenium, a class name having space will not be parsed and will throw the error.
